...
begin
	json_data = JSON3.read(open("../data/complexities_$MAP.json", "r"))
...
# ╔═╡ ff4f1031-2666-4627-9c10-d1b881f681fd
for l in rn_ma
	merge!(l, Dict("ec1" => rn2ec1[l["rn"]], "ec2" => rn2ec2[l["rn"]]))
end

# ╔═╡ 4c876f9f-a08f-4e3d-bb0e-4818dc394368
rn_ma

# ╔═╡ 9a156bbe-8e5d-4ccb-ab48-8d261ac6f869
rn_ma
...
# ╔═╡ f73e6020-021d-41a6-a1df-808e2d39c3d4
draw(
	data(rn_ma) *
		mapping(
			:ec2 => first,
...
# ╔═╡ 46644000-e48c-4bd2-943e-2032943e4af3
rn_ma
...
manifest_format = "2.0"
project_hash = "abc9fdfbecedaf55401a47f0d7233543b3efbc75"
